...
#
# Migrated verbatim from images/rpi/build_files/11-hailo1x-pcie-driver.sh -- only
# change is the final `cp` to /rpms/kmods/ instead of the main image installing this
# rpm directly.
#
# Separate chip generation from 20-hailo8-pci.sh's Hailo-8/8L: different module
